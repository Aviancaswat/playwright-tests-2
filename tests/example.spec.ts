...
test.describe('Comenzo prueba avianca', () => {
    ...
    test('prueba home avianca', async ({ }, testInfo) => {
        ...
        // Variables de navegador, contexto y página
        let browser: any;
        let context: any;
        let page: any;
        let step = 0;
        ...
        try {
            // Función para adjuntar capturas
            ...
            // Lanzar navegador mediante playwright-extra
            ...
            // Crear contexto con grabación de vídeo
            ...
            // Navegación y pasos de prueba...
            await page.goto('https://www.avianca.com/' + idioma + '/', { waitUntil: 'domcontentloaded' });
            ...
            // Bloque final para garantizar vídeo aunque falle
            if (context) {
